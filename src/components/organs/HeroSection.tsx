...
const HeroSection = () => {
  // const navigate = useNavigate();
    return (
      <section className="w-full lg:h-screen md:h-[550px] h-[830px] relative flex justify-end">
        ...
        <main className="w-full lg:h-full h-auto grid md:grid-cols-2 absolute top-0 left-0 lg:px-24 md:px-8 px-5 pt-24 md:pt-32 lg:pt-0">
          <div className="flex flex-col justify-center md:gap-6 gap-3 md:order-1 order-2">
            <Text
              as="p"
              className="text-color1 uppercase tracking-widest lg:text-base  text-sm font-normal text-green-700 text-bold"
            >
              <Fade>{HeroTexts.firstText}</Fade>
            </Text>
            <Text
              as="h1"
              className=" text-color3 lg:text-4xl md:text-5xl text-3xl font-medium"
            >
